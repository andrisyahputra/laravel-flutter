...
Route::post('image/uploud', [UploudController::class, 'uploudImage'])->middleware('auth:sanctum');
Route::post('image/uploud-multi', [UploudController::class, 'uploudMultiImage'])->middleware('auth:sanctum');
